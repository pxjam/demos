...
(function() {
    // ======== private vars ========
    let scr, canvas, cubes, faces, nx, ny, nw, nh, xm = 0, ym = 0, cx = 50, cy = 50, cz = 0, cxb = 0, cyb = 0
    let white, alpha, fps = 0, ncube, npoly, faceOver, drag, moved, startX = 0, startY = 0
    let cosY, sinY, cosX, sinX, cosZ, sinZ, minZ, angleY = 0, angleX = 0, angleZ = 0
    let bkgColor1 = 'rgba(0,0,0,0.1)'
    let bkgColor2 = 'rgba(32,32,32,1)'
    let autorotate = false, destroy = false, running = true
    // ---- fov ----
    let fl = 250
    let zoom = 0
    // ======== canvas constructor ========
    ...
    // ======== vertex constructor ========
    let Point = function(parent, xyz, project) {
    ...
    // ======== Cube constructor ========
    let Cube = function(parent, nx, ny, nz, x, y, z, w) {
        if (parent) {
